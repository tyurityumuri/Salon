        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <p className="text-sm">〒100-0004</p>
              <p className="text-sm">東京都千代田区大手町1-1-1</p>
            ...
            <div className="space-y-4">
              <div>
                <a
                  ...
                  className="inline-flex items-center px-4 py-2 bg-ocean-blue-600 text-white rounded-md hover:bg-ocean-blue-700 transition-colors text-sm"
                >
                  電話で予約
                </a>
              </div>
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="text-gray-400 hover:text-ocean-blue-400 transition-colors"
