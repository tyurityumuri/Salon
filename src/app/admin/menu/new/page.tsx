      ...
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center py-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">新しいメニューを追加</h1>
              <p className="text-gray-600">メニュー情報を入力してください</p>
            </div>
          </div>
        </div>
      </header>
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-ocean-blue-500 focus:border-ocean-blue-500 sm:text-sm"
                      placeholder="お客様の髪質や顔型に合わせたカットを行います..."
                    />
                  </div>
